...
"""autogenerated by genpy from bio_ik_msgs/GetIKRequest.msg. Do not edit."""
import codecs
import sys
...
class GetIKRequest(genpy.Message):
  _md5sum = "05a37800a972d62c5bb9f38f4edec530"
  _type = "bio_ik_msgs/GetIKRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """IKRequest ik_request
...
"""
  ...
  _slot_types = ['bio_ik_msgs/IKRequest']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.ik_request is None:
        self.ik_request = bio_ik_msgs.msg.IKRequest()
    else:
      self.ik_request = bio_ik_msgs.msg.IKRequest()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.ik_request.robot_description
      length = len(_x)
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B2i().pack(_x.ik_request.approximate, _x.ik_request.timeout.secs, _x.ik_request.timeout.nsecs))
      length = len(self.ik_request.fixed_joints)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.fixed_joints:
        length = len(val1)
      ...
      _x = self
      buff.write(_get_struct_2B().pack(_x.ik_request.robot_state.is_diff, _x.ik_request.avoid_collisions))
      length = len(self.ik_request.position_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.position_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v21
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_request.orientation_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.orientation_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v22
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.ik_request.pose_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.pose_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        buff.write(_get_struct_d().pack(_x))
      length = len(self.ik_request.look_at_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.look_at_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v27
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_request.min_distance_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.min_distance_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1.distance
        buff.write(_get_struct_d().pack(_x))
      length = len(self.ik_request.max_distance_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.max_distance_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = val1.distance
        buff.write(_get_struct_d().pack(_x))
      length = len(self.ik_request.line_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.line_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v31
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_request.touch_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.touch_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v33
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_request.avoid_joint_limits_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.avoid_joint_limits_goals:
        _x = val1
        buff.write(_get_struct_dB().pack(_x.weight, _x.primary))
      length = len(self.ik_request.center_joints_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.center_joints_goals:
        _x = val1
        buff.write(_get_struct_dB().pack(_x.weight, _x.primary))
      length = len(self.ik_request.minimal_displacement_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.minimal_displacement_goals:
        _x = val1
        buff.write(_get_struct_dB().pack(_x.weight, _x.primary))
      length = len(self.ik_request.joint_variable_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.joint_variable_goals:
      ...
      length = len(self.ik_request.balance_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.balance_goals:
        _x = val1.weight
        buff.write(_get_struct_d().pack(_x))
        _v34 = val1.target
        _x = _v34
        ...
        _x = _v35
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_request.side_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.side_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v37
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_request.direction_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.direction_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v39
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_request.cone_goals)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_request.cone_goals:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.ik_request.robot_description = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.ik_request.robot_description = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.ik_request.approximate, _x.ik_request.timeout.secs, _x.ik_request.timeout.nsecs,) = _get_struct_B2i().unpack(str[start:end])
      self.ik_request.approximate = bool(self.ik_request.approximate)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.fixed_joints = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_request.fixed_joints.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (_x.ik_request.robot_state.is_diff, _x.ik_request.avoid_collisions,) = _get_struct_2B().unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.position_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_request.position_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.orientation_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.ik_request.orientation_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.pose_goals = []
      for i in range(0, length):
        ...
        self.ik_request.pose_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.look_at_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_request.look_at_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.min_distance_goals = []
      for i in range(0, length):
        ...
        self.ik_request.min_distance_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.max_distance_goals = []
      for i in range(0, length):
        ...
        (val1.distance,) = _get_struct_d().unpack(str[start:end])
        self.ik_request.max_distance_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.line_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_request.line_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.touch_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_request.touch_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.avoid_joint_limits_goals = []
      for i in range(0, length):
        ...
        self.ik_request.avoid_joint_limits_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.center_joints_goals = []
      for i in range(0, length):
        ...
        (_x.weight, _x.primary,) = _get_struct_dB().unpack(str[start:end])
        val1.primary = bool(val1.primary)
        self.ik_request.center_joints_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.minimal_displacement_goals = []
      for i in range(0, length):
        ...
        (_x.weight, _x.primary,) = _get_struct_dB().unpack(str[start:end])
        val1.primary = bool(val1.primary)
        self.ik_request.minimal_displacement_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.joint_variable_goals = []
      for i in range(0, length):
        ...
        self.ik_request.joint_variable_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.balance_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_request.balance_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.side_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_request.side_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.direction_goals = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_request.direction_goals.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_request.cone_goals = []
      for i in range(0, length):
        ...
        self.ik_request.cone_goals.append(val1)
      return self
...
def _get_struct_dB():
    ...
    return _struct_dB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from bio_ik_msgs/GetIKResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetIKResponse(genpy.Message):
  _md5sum = "e785ec4c647f2b72ebcf3efd0f50c7e5"
  _type = "bio_ik_msgs/GetIKResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """IKResponse ik_response
...
"""
  __slots__ = ['ik_response']
  _slot_types = ['bio_ik_msgs/IKResponse']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      # message fields cannot be None, assign default values for those that are
      if self.ik_response is None:
        self.ik_response = bio_ik_msgs.msg.IKResponse()
    else:
      self.ik_response = bio_ik_msgs.msg.IKResponse()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.ik_response.solution.joint_state.header.seq, _x.ik_response.solution.joint_state.header.stamp.secs, _x.ik_response.solution.joint_state.header.stamp.nsecs))
      _x = self.ik_response.solution.joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.ik_response.solution.joint_state.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_response.solution.joint_state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.ik_response.solution.joint_state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ik_response.solution.joint_state.position))
      length = len(self.ik_response.solution.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ik_response.solution.joint_state.velocity))
      length = len(self.ik_response.solution.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ik_response.solution.joint_state.effort))
      _x = self
      buff.write(_get_struct_3I().pack(_x.ik_response.solution.multi_dof_joint_state.header.seq, _x.ik_response.solution.multi_dof_joint_state.header.stamp.secs, _x.ik_response.solution.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.ik_response.solution.multi_dof_joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.ik_response.solution.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_response.solution.multi_dof_joint_state.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.ik_response.solution.multi_dof_joint_state.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_response.solution.multi_dof_joint_state.transforms:
        ...
        _x = _v170
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.ik_response.solution.multi_dof_joint_state.twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_response.solution.multi_dof_joint_state.twist:
        _v171 = val1.linear
        _x = _v171
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v172 = val1.angular
        _x = _v172
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_response.solution.multi_dof_joint_state.wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_response.solution.multi_dof_joint_state.wrench:
        _v173 = val1.force
        _x = _v173
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v174 = val1.torque
        _x = _v174
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      length = len(self.ik_response.solution.attached_collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_response.solution.attached_collision_objects:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        buff.write(_get_struct_d().pack(_x))
      _x = self
      buff.write(_get_struct_Bid().pack(_x.ik_response.solution.is_diff, _x.ik_response.error_code.val, _x.ik_response.solution_fitness))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ik_response.solution.joint_state.header.seq, _x.ik_response.solution.joint_state.header.stamp.secs, _x.ik_response.solution.joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.ik_response.solution.joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.ik_response.solution.joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_response.solution.joint_state.name = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_response.solution.joint_state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_response.solution.joint_state.position = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_response.solution.joint_state.velocity = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_response.solution.joint_state.effort = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
      (_x.ik_response.solution.multi_dof_joint_state.header.seq, _x.ik_response.solution.multi_dof_joint_state.header.stamp.secs, _x.ik_response.solution.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.ik_response.solution.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.ik_response.solution.multi_dof_joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_response.solution.multi_dof_joint_state.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.ik_response.solution.multi_dof_joint_state.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_response.solution.multi_dof_joint_state.transforms = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Transform()
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.ik_response.solution.multi_dof_joint_state.transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_response.solution.multi_dof_joint_state.twist = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Twist()
        _v191 = val1.linear
        _x = _v191
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_response.solution.multi_dof_joint_state.twist.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_response.solution.multi_dof_joint_state.wrench = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.Wrench()
        _v193 = val1.force
        _x = _v193
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.ik_response.solution.multi_dof_joint_state.wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ik_response.solution.attached_collision_objects = []
      for i in range(0, length):
        val1 = moveit_msgs.msg.AttachedCollisionObject()
        start = end
        end += 4
        ...
        if python3:
          _v195.id = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v195.id = str[start:end]
        _v198 = _v195.type
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        for i in range(0, length):
          ...
          val3.dimensions = s.unpack(str[start:end])
          _v195.primitives.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v195.primitive_poses = []
        for i in range(0, length):
          val3 = geometry_msgs.msg.Pose()
          _v199 = val3.position
          _x = _v199
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v195.primitive_poses.append(val3)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v195.meshes = []
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
          _v195.plane_poses.append(val3)
        start = end
        end += 1
        (_v195.operation,) = _get_struct_b().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.touch_links = []
        ...
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.ik_response.solution.attached_collision_objects.append(val1)
      _x = self
      start = end
      end += 13
      (_x.ik_response.solution.is_diff, _x.ik_response.error_code.val, _x.ik_response.solution_fitness,) = _get_struct_Bid().unpack(str[start:end])
      self.ik_response.solution.is_diff = bool(self.ik_response.solution.is_diff)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ik_response.solution.joint_state.position.tostring())
      length = len(self.ik_response.solution.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ik_response.solution.joint_state.velocity.tostring())
      length = len(self.ik_response.solution.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ik_response.solution.joint_state.effort.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.ik_response.solution.multi_dof_joint_state.header.seq, _x.ik_response.solution.multi_dof_joint_state.header.stamp.secs, _x.ik_response.solution.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.ik_response.solution.multi_dof_joint_state.header.frame_id
      length = len(_x)
      ...
      for val1 in self.ik_response.solution.attached_collision_objects:
        ...
        for val3 in _v215.mesh_poses:
          ...
          _x = _v222
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        length = len(_v215.planes)
        buff.write(_struct_I.pack(length))
        for val3 in _v215.planes:
          buff.write(val3.coef.tostring())
        length = len(_v215.plane_poses)
        buff.write(_struct_I.pack(length))
        for val3 in _v215.plane_poses:
          _v223 = val3.position
          _x = _v223
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.ik_response.solution.joint_state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_response.solution.joint_state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_response.solution.joint_state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.ik_response.solution.multi_dof_joint_state.header.seq, _x.ik_response.solution.multi_dof_joint_state.header.stamp.secs, _x.ik_response.solution.multi_dof_joint_state.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v238.key = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v238.key = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v238.db = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v238.db = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v235.primitives = []
        ...
        for i in range(0, length):
          ...
          val3.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
          _v248 = val3.time_from_start
          _x = _v248
          start = end
          end += 8
          (_x.secs, _x.nsecs,) = _get_struct_2i().unpack(str[start:end])
          _v245.points.append(val3)
        start = end
        end += 8
        (val1.weight,) = _get_struct_d().unpack(str[start:end])
        self.ik_response.solution.attached_collision_objects.append(val1)
...
def _get_struct_d():
    ...
    return _struct_d
class GetIK(object):
  _type          = 'bio_ik_msgs/GetIK'
  _md5sum = '3422cd279819e8c14de8099ea8669f52'
