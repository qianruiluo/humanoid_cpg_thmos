...
"""autogenerated by genpy from bio_ik_msgs/IKResponse.msg. Do not edit."""
import codecs
import sys
...
class IKResponse(genpy.Message):
  _md5sum = "ad2ae55f8539ae5916416131236a8e44"
  _type = "bio_ik_msgs/IKResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """moveit_msgs/RobotState solution
...
"""
  __slots__ = ['solution','error_code','solution_fitness']
  _slot_types = ['moveit_msgs/RobotState','moveit_msgs/MoveItErrorCodes','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       solution,error_code,solution_fitness
    ...
    if args or kwds:
      ...
      if self.solution_fitness is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_Bid().pack(_x.solution.is_diff, _x.error_code.val, _x.solution_fitness))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.solution.is_diff, _x.error_code.val, _x.solution_fitness,) = _get_struct_Bid().unpack(str[start:end])
