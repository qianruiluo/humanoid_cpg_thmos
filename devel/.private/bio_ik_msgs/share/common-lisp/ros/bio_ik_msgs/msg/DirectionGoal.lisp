...
(cl:defclass <DirectionGoal> (roslisp-msg-protocol:ros-message)
  ((link_name
    :reader link_name
    :initarg :link_name
    :type cl:string
...
(cl:defclass DirectionGoal (<DirectionGoal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <DirectionGoal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'DirectionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bio_ik_msgs-msg:<DirectionGoal> is deprecated: use bio_ik_msgs-msg:DirectionGoal instead.")))

(cl:ensure-generic-function 'link_name-val :lambda-list '(m))
(cl:defmethod link_name-val ((m <DirectionGoal>))
...
(cl:defmethod weight-val ((m <DirectionGoal>))
...
(cl:defmethod axis-val ((m <DirectionGoal>))
...
(cl:defmethod direction-val ((m <DirectionGoal>))
  ...
  (direction m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DirectionGoal>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DirectionGoal>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DirectionGoal>)))
  "Returns string type for a message object of type '<DirectionGoal>"
  "bio_ik_msgs/DirectionGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DirectionGoal)))
  "Returns string type for a message object of type 'DirectionGoal"
  "bio_ik_msgs/DirectionGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DirectionGoal>)))
  "Returns md5sum for a message object of type '<DirectionGoal>"
  "6075759add2b8333cf00f76cb2d6cc74")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DirectionGoal)))
  "Returns md5sum for a message object of type 'DirectionGoal"
  "6075759add2b8333cf00f76cb2d6cc74")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DirectionGoal>)))
  "Returns full string definition for message of type '<DirectionGoal>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DirectionGoal)))
  "Returns full string definition for message of type 'DirectionGoal"
  (cl:format cl:nil "# The name of this goal's end effector link~%string link_name~%~%# Weight of the current goal~%# Goals with a higher weight will have a stronger influence than goals with a smaller weight~%float64 weight~%~%geometry_msgs/Vector3 axis~%~%geometry_msgs/Vector3 direction~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <DirectionGoal>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DirectionGoal>))
  "Converts a ROS message object to a list"
  (cl:list 'DirectionGoal
