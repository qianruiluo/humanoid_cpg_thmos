...
(cl:defclass <MinDistanceGoal> (roslisp-msg-protocol:ros-message)
  ((link_name
    :reader link_name
    :initarg :link_name
    :type cl:string
...
(cl:defclass MinDistanceGoal (<MinDistanceGoal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MinDistanceGoal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MinDistanceGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bio_ik_msgs-msg:<MinDistanceGoal> is deprecated: use bio_ik_msgs-msg:MinDistanceGoal instead.")))

(cl:ensure-generic-function 'link_name-val :lambda-list '(m))
(cl:defmethod link_name-val ((m <MinDistanceGoal>))
...
(cl:defmethod weight-val ((m <MinDistanceGoal>))
...
(cl:defmethod target-val ((m <MinDistanceGoal>))
...
(cl:defmethod distance-val ((m <MinDistanceGoal>))
  ...
  (distance m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MinDistanceGoal>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MinDistanceGoal>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MinDistanceGoal>)))
  "Returns string type for a message object of type '<MinDistanceGoal>"
  "bio_ik_msgs/MinDistanceGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MinDistanceGoal)))
  "Returns string type for a message object of type 'MinDistanceGoal"
  "bio_ik_msgs/MinDistanceGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MinDistanceGoal>)))
  "Returns md5sum for a message object of type '<MinDistanceGoal>"
  "bcfa7c3e29387935515d0e4b0708f298")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MinDistanceGoal)))
  "Returns md5sum for a message object of type 'MinDistanceGoal"
  "bcfa7c3e29387935515d0e4b0708f298")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MinDistanceGoal>)))
  "Returns full string definition for message of type '<MinDistanceGoal>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MinDistanceGoal)))
  "Returns full string definition for message of type 'MinDistanceGoal"
  (cl:format cl:nil "# The name of this goal's end effector link~%string link_name~%~%# Weight of the current goal~%# Goals with a higher weight will have a stronger influence than goals with a smaller weight~%float64 weight~%~%# The distance will be computed from the origin of the end effector link to the target point~%geometry_msgs/Point target~%~%# Minimum allowed distance~%# Forces the end effector link to be at least the specified distance away from the target~%float64 distance~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MinDistanceGoal>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MinDistanceGoal>))
  "Converts a ROS message object to a list"
  (cl:list 'MinDistanceGoal
