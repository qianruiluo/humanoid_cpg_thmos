...
class MinimalDisplacementGoal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MinimalDisplacementGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MinimalDisplacementGoal(null);
...
module.exports = MinimalDisplacementGoal;
