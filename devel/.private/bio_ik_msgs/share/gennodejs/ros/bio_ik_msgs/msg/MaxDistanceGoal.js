...
class MaxDistanceGoal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MaxDistanceGoal(null);
  ...
  static datatype() {
    ...
    return 'bio_ik_msgs/MaxDistanceGoal';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MaxDistanceGoal(null);
...
module.exports = MaxDistanceGoal;
