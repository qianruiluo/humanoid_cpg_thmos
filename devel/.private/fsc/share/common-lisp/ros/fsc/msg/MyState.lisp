...
(cl:defmethod cl:initialize-instance :after ((m <MyState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fsc-msg:<MyState> is deprecated: use fsc-msg:MyState instead.")))

(cl:ensure-generic-function 'cx-val :lambda-list '(m))
(cl:defmethod cx-val ((m <MyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fsc-msg:cx-val is deprecated.  Use fsc-msg:cx instead.")
  (cx m))

(cl:ensure-generic-function 'dcx-val :lambda-list '(m))
(cl:defmethod dcx-val ((m <MyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fsc-msg:dcx-val is deprecated.  Use fsc-msg:dcx instead.")
  (dcx m))

(cl:ensure-generic-function 'cy-val :lambda-list '(m))
(cl:defmethod cy-val ((m <MyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fsc-msg:cy-val is deprecated.  Use fsc-msg:cy instead.")
  (cy m))

(cl:ensure-generic-function 'dcy-val :lambda-list '(m))
(cl:defmethod dcy-val ((m <MyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fsc-msg:dcy-val is deprecated.  Use fsc-msg:dcy instead.")
  (dcy m))

(cl:ensure-generic-function 'is_left_support-val :lambda-list '(m))
(cl:defmethod is_left_support-val ((m <MyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fsc-msg:is_left_support-val is deprecated.  Use fsc-msg:is_left_support instead.")
  (is_left_support m))

(cl:ensure-generic-function 'is_right_support-val :lambda-list '(m))
(cl:defmethod is_right_support-val ((m <MyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fsc-msg:is_right_support-val is deprecated.  Use fsc-msg:is_right_support instead.")
  (is_right_support m))
