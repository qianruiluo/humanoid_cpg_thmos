...
rospy.wait_for_service("/bio_ik/get_approximate_ik")
get_approximate_ik = rospy.ServiceProxy("/bio_ik/get_approximate_ik", moveit_msgs.srv.GetPositionIK)
...
response = get_approximate_ik(request)
