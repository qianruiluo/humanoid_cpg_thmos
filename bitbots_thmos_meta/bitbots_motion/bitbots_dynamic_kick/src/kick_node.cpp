...
bool KickNode::init(const bitbots_msgs::KickGoal &goal_msg,
  ...
  Eigen::Isometry3d trunk_to_l_sole = current_state_->getGlobalLinkTransform(l_sole_frame_);
  Eigen::Isometry3d trunk_to_r_sole = current_state_->getGlobalLinkTransform(r_sole_frame_);
